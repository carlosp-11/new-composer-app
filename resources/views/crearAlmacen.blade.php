    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="text-center">
                <h1 class="text-center text-secondary pt-5">Crea un almacén</h1>
            </div>
            @if ($errors->any())
            ...
            @endif      
            <div class="">
                <form action="/nuevo-almacen" method="POST" class="py-3 px-3" id="formulario">
                    @csrf
                    <div class="mb-3">
