...
<html lang="en">
    <head>
        ...
        <title>Edita una categoria </title>
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="text-center">                
                    <h1 class="text-center text-secondary pt-5"> Edita una categoría </h1>
            </div>
            @if ($errors->any())
            ...
            <div class="">
                <form method="POST" class="py-3 px-3" id="formulario" >
                    ...
                    <a href="{{ url('/categorias') }}" class="btn btn-danger mb-4 text-center"> Cancelar </a>
                </form>
            </div>
        </div>            
    </body>
