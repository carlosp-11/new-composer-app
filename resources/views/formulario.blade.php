...
<body>
    <div class="container-fluid">
        ...
        @if (session('error'))
            ...
            @endif      
        <div class="">
            <form action="/formulario" method="POST" class="py-3 px-3" id="formulario">
                @csrf
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="mercadona" name="mercadona" value="1">
                        <label class="form-check-label" for="mercadona">Mercadona</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="
                        " name="alteza" value="2">
                        <label class="form-check-label" for="alteza">Alteza</label>
                    </div>
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="lidl" name="lidl" value="3">
